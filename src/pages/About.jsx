  ...
  return (
    <div className="pt-24 pb-16">
      ...
      <section className="py-12 bg-white dark:bg-gray-900">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-12 text-left">Education</h2>

            <div className="flex justify-center">
              <motion.div
                className="w-full max-w-4xl bg-gray-50 dark:bg-gray-800 rounded-2xl shadow-lg p-8" // changed max-w-2xl to max-w-4xl
                variants={containerVariants}
                initial="hidden"
                whileInView="visible"
                viewport={{ once: true, amount: 0.2 }}
                ...
                <div className="space-y-8">
                  {profile.education.map((edu, index) => (
                    ...
                    >
                      ...
                      <h4 className="text-lg text-blue-700 dark:text-blue-300 mb-1">{edu.institution}</h4>
