        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8 lg:gap-12">
            ...
            >
              ...
              >
                {['Javascript', 'React', 'Tailwind CSS', 'Node.js', 'Express', 'MongoDB'].map((tech, index) => (
                  <motion.span
                    key={tech}
              ...
              >
                ...
                <div className="bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm p-3 sm:p-4 rounded-lg sm:rounded-xl shadow-sm border border-gray-100 dark:border-gray-700">
                  <p className="text-2xl sm:text-3xl md:text-4xl font-bold text-purple-600 dark:text-purple-400">10+</p>
                ...
                <div className="bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm p-3 sm:p-4 rounded-lg sm:rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 col-span-1 xs:col-span-2 sm:col-span-1">
                  <p className="text-2xl sm:text-3xl md:text-4xl font-bold text-indigo-600 dark:text-indigo-400">5+</p>
                  <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-300 mt-0.5 sm:mt-1">Team Projects</p>
                </div>
              </motion.div>
