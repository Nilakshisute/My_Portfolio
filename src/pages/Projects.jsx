...
const Projects = () => {
  ...
  return (
    <div className="pt-6 pb-12">
      ...
      {/* Header Section */}
       <section id="projects" className="py-12 bg-gradient-to-b from-white to-gray-100 dark:from-gray-900 dark:to-gray-800">
              ...
              {filteredProjects.map((project) => (
                ...
                >
                  <div className="relative overflow-hidden rounded-t-lg h-48 bg-gray-200 dark:bg-gray-700">
                    <div className="absolute inset-0 bg-black-600 bg-opacity-80 flex items-center justify-center opacity-0 group-hover:opacity-200 transition-opacity duration-300">
