...
const EnhancedNavbar = ({ activeSection, scrollToSection }) => {
  ...
  const socialLinks = [
    ...
    },
    {
      ...
      url: 'https://www.linkedin.com/in/nilakshi-sute-8b6577245/',
        ...
        <div className="container mx-auto px-4 sm:px-6 flex justify-between items-center">
          ...
          >
            ...
            >
              ...
              {/* Add a visible space between "Nilakshi" and "Sute" */}
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <div className="flex space-x-6">
              {navLinks.map((link, idx) => (
                <motion.button
                  ...
                  className={`text-sm font-medium transition-all duration-300 relative group focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-400 focus-visible:ring-offset-2 focus-visible:rounded-md px-3 py-2 rounded-xl ${activeSection === link.id
            ...
            >
              ...
              <motion.button
                onClick={toggleTheme}
                className={`p-2 rounded-full transition-all duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-violet-400 focus-visible:ring-offset-2 ${theme === 'dark'
          ...
          <div className="flex items-center space-x-4 md:hidden">
            ...
            <motion.button
              ...
              className={`p-2 rounded-full transition-all duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-violet-400 focus-visible:ring-offset-2 ${isOpen
                  ...
                  <nav className="flex flex-col space-y-3">
                    {navLinks.map((link, index) => (
                      ...
                      >
                        <button
                          onClick={() => handleNavClick(link.id)}
                          className={`text-base font-medium py-3 px-4 rounded-xl flex items-center justify-between transition-all duration-300 w-full text-left focus:outline-none focus-visible:ring-2 focus-visible:ring-violet-400 ${activeSection === link.id
                              ? `${theme === 'dark'
                        ...
                        >
                          <div className="flex items-center space-x-3">
                            ...
                            <span className={`flex items-center justify-center p-2 rounded-lg ${activeSection === link.id
